...
global UUID := "d268f63d67034b4d9671f16dd18f91c4"
...
Check_Weapon(Weapon_Pic) {
    Loop, 3 {
        ImageSearch, FoundX, FoundY, 1520, 1000, 1824, 1057,*50 %A_ScriptDir%\Image\EN\%Weapon_pic%.png
		If (ErrorLevel != 0) {
			Return False
        }
    }
...
Detect_Weapon() {
    AmmoType := 0
    PixelGetColor, AmmoType1, 1521, 1038
    PixelGetColor, AmmoType2, 1824, 1036
